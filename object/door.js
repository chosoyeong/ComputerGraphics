class Door {
    ...
    static quad(pointsArray, colorsArray, a, b, c, d)
    {
      var vertices = [
        //1
        vec4( -0.4,  0.0,  0.05, 1.0 ), //0
        vec4( -0.4,  1.6,  0.05, 1.0 ), //1
        vec4(  0.4,  1.6,  0.05, 1.0 ), //2
        vec4(  0.4,  0.0,  0.05, 1.0 ), //3
        vec4( -0.4,  0.0, 0.0, 1.0 ), //4
        vec4( -0.4,  1.6, 0.0, 1.0 ), //5
        vec4(  0.4,  1.6, 0.0, 1.0 ), //6
        vec4(  0.4,  0.0, 0.0, 1.0 ),  //7
