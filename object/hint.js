class Hint {
    ...
    static GetVertexColor(pointsArray, colorsArray){
      var texCoord=[ //
      vec2(0.75, 0.775),//오른쪽 위
      vec2(0.75, 0.52),//오른쪽 아래
        vec2(0.99, 0.52),//왼쪽 아래
        vec2(0.99, 0.775),//왼쪽 위
      ];
      // var texCoord=[ //
      //   vec2(0.85, 1.0),//오른쪽 위
    ...
    static quad(pointsArray, colorsArray, a, b, c, d)
    {
      var vertices = [
        //1
        vec4( -0.8,  0.0,  0.001, 1.0 ), //0
        vec4( -0.8,  0.8,  0.001, 1.0 ), //1
        vec4(  0.8,  0.8,  0.001, 1.0 ), //2
        vec4(  0.8,  0.0,  0.001, 1.0 ), //3
        vec4( -0.8,  0.0, 0.0, 1.0 ), //4
        vec4( -0.8,  0.8, 0.0, 1.0 ), //5
        vec4(  0.8,  0.8, 0.0, 1.0 ), //6
        vec4(  0.8,  0.0, 0.0, 1.0 ),  //7
